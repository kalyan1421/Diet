...
class _diet_pageState extends State<diet_page> {
  final ref11 = FirebaseDatabase.instance.ref("userdetails").child(SessionController().userId.toString());
  final userdetails = FirebaseDatabase.instance.ref("userdetails").child(SessionController().userId.toString());late int calories;
  @override
                ...
                child: Column(children: [
                    ...
                    Row(children: [const SizedBox(width: 30,),
                        Container(width: 70,height: 70,
                          decoration: ShapeDecoration(color: Colors.transparent, shape: CircleBorder (side: BorderSide(width: 4, color: Colors.blueGrey.shade200))),
                          child: Image.asset("assets/icons8-restaurant-64.png",color: Colors.pinkAccent,scale: 1.5,),),
                        const SizedBox(width: 5,), const Text("Eat up to ",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.normal)),
                        calories_user(),],),
                    const SizedBox(height: 10,),
                    bmi()],),),),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        Padding(padding: const EdgeInsets.all(14),
                              ...
                              children: [
                                ...
                                Image.asset("assets/icons8-rice-bowl-100.png",color: Colors.black,scale: 4,),
                                const SizedBox(width: 10,),
                                Text("Recipes",style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.black),)
                              ],
                            ),),
                      ),
                      ...
                      Container(
                        ...
                        child: Padding(padding: const EdgeInsets.all(14),
                          child: Row(
                            children: [
                              Image.asset("assets/icons8-fire-90.png",color: Colors.black,scale: 4,),
                              const SizedBox(width: 5,),
                              Text("Edit Calories",style: GoogleFonts.abel(fontWeight: FontWeight.w600, fontSize: 19, color: Colors.black),)
                            ],
                          ),),
                      ),
                      const SizedBox(width: 6,),
                      Container(
                        ...
                        child: Padding(padding: const EdgeInsets.all(14),
                          child: Row(
                            children: [
                              Image.asset("assets/icons8-bowl-with-spoon-100.png",color: Colors.black,scale: 4,),
                              const SizedBox(width: 5,),
                              Text("Saved Meals",style: GoogleFonts.abel(fontWeight: FontWeight.w600, fontSize: 19, color: Colors.black),)
                            ],
                          ),),
                      ),
                      const SizedBox(width: 6,),
                        ...
                        child: Padding(padding: const EdgeInsets.all(10),
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 5,),
                              Text("Food Reminder",style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black),)
                            ],
                          ),),
                      ),
            ...
            StreamBuilder(
                stream: ref1.onValue, builder: (context, AsyncSnapshot snapshot) {
                  if(snapshot.hasData ) {
                    ...
                    if(condition == "PCOD" || condition == "Diabetes Type 1"|| condition == "Diabetes Type 2"||condition == "None" ||condition == "Cholesterol"){
                      return Padding(
                        ...
                        child: Container(width: width/2, height: width/2,
                          ...
                          child: Column(crossAxisAlignment:  CrossAxisAlignment.start,
                            children: [
                              Padding(padding: const EdgeInsets.only(left: 10,top: 6), child: Text("Macros Ratio",style: GoogleFonts.abel(fontSize: 20, color: Colors.grey.shade800, fontWeight: FontWeight.bold)),),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text("Calories",style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black),),
                                        ...
                                        StreamBuilder(
                                            ...
                                            builder: (context, AsyncSnapshot snapshot) {
                                              if (snapshot.hasData && snapshot.data != null) {
                                                ...
                                                return Text("$usercalories Cal", style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.grey.shade800),);}
                                              else{return const Text("Loading" ,style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold));}}
                                        ),
                                      ],
                                    ),
                                    const SizedBox(height: 5),
                                    Container(height: 10, width: width/1.2, decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: Colors.green,),),
                                  ],
                                ),
                              ),
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Column(children: [
                                        Text("Cards",style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black),),
                                        const SizedBox(height: 2),
                                        Stack(children: <Widget>[
                                          Container(height: 10, width: width/5,decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: Colors.black12,),),
                                          Container(height: 10, width: width/8, decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: Colors.orangeAccent,),),
                                        ],),
                                      ...
                                      Column(children: [
                                        Text("Fat",style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black),),
                                        const SizedBox(height: 2),
                                        Row(
                                          children: [
                                            Stack(children: <Widget>[
                                              Container(height: 10, width: width/5,decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: Colors.black12,),),
                                              Container(height: 10, width: width/11, decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: Colors.purple,),),
                                            ],),
                                          ],
                                        ),
                                        const SizedBox(height: 8),
                                      ...
                                      const SizedBox(width: 8,),
                                      Column(children: [
                                        Text("Protein",style: GoogleFonts.abel(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.black),),
                                        const SizedBox(height: 2),
                                        Row(
                                          children: [
                                            Stack(children: <Widget>[
                                              Container(height: 10, width: width/5,decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(5)), color: Colors.black12,),),
                                              Container(height: 10, width: width/18, decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(5)), color: Colors.pink.shade300,),),
                                            ],),
                                            const SizedBox(width: 5),
                                          ],
                                        ),
                                            ...
                                            StreamBuilder(
                                              ...
                                              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                                                if(snapshot.hasData){
                                                  ...
                                                  return Text("${protein.round()}g | 20%", );
                                                }
                                                return const Text("Loading");
                                              },
                                            )
                            ...
                            child: Column(crossAxisAlignment:  CrossAxisAlignment.start,
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Image.asset("assets/icons8-important-event-50.png", scale: 2,),
                                      const SizedBox(width: 8,),
                                      Text("Note:   As you are in 1st Trimester \nthere is no extra calories required",
                                          style: GoogleFonts.catamaran( fontSize: 15 ,fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                )
                              ],
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Image.asset("assets/icons8-important-event-50.png", scale: 2,),
                                      const SizedBox(width: 8,),
                                      Text("Note:   As you are in 3rd Trimester \n400 extra calories required",
                                          style: GoogleFonts.catamaran( fontSize: 15 ,fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                )
...
class calories_user extends StatelessWidget {
  final ref1 = FirebaseDatabase.instance.ref("userdetails").child(SessionController().userId.toString());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, AsyncSnapshot snapshot){
          if (snapshot.hasData && snapshot.data != null){
            var usercalories = snapshot.data.snapshot.value['calories'];
            return Text("$usercalories Calories", style: const TextStyle(fontSize: 18.0,fontWeight: FontWeight.normal),);
          }
          else{return const Text("Loading " ,style: TextStyle(fontSize: 10.0, letterSpacing: 1.5, fontWeight: FontWeight.bold));
          }
        }
    );
  }
...
class bmi extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(stream: ref11.onValue,builder: (context, AsyncSnapshot snapshot){
      if(snapshot.hasData){
        var bmi = snapshot.data.snapshot.value['bmi'];
        if(bmi<18.5){
          return Text("Your BMI is $bmi You are in the Underweight range",style: const TextStyle(fontSize: 16.0,fontWeight: FontWeight.normal));
        }
        else if(bmi<24.9){
          return Text("Your BMI is $bmi You are in the Healthy Weight range",style: const TextStyle(fontSize: 16.0,fontWeight: FontWeight.normal));
        }
        else if(bmi<29){
          return Text("Your BMI is $bmi You are in the Overweight range",style: const TextStyle(fontSize: 16.0,fontWeight: FontWeight.normal));
        }
        else if(bmi>30){
          return Text("Your BMI is $bmi You are in the Obese range.",style: const TextStyle(fontSize: 16.0,fontWeight: FontWeight.normal));
        }
      }
      return Center(child: Text("Loading" , style: headingStyle,));
    });
